...
public class LDSQueueTry {
    ...
    public static void main(String[] args) throws IOException {
        ...
        new LDSQueueTry(scanner, TIME_LIMIT, switch_number);
    }
     ...
     */
    public LDSQueueTry(Scanner sc, long limit, int switchNum) throws IOException {
       ...
       // 	printRecord();
        ...
        for(int i = 0; i < 1; ++i) {
            ...
            for(int k = 0; k < vset3.length; k++){
            	...
            	if((wt[vset3[0]]<wt[vset3[k]])&&(degree[vset3[0]] < degree[vset3[k]])) {
            		for(int p = k-1; p >= 0; p--) {
            			int temp = vset3[p];
